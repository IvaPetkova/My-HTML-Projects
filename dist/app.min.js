...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,r){for(var n=0;n<r.length;n++){var a=r[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(r,n,a){return n&&e(r.prototype,n),a&&e(r,a),r}}(),template=require("../../src/views/index.hbs"),Search=require("./pages/search.js"),App=function(){function e(){_classCallCheck(this,e),this._render()}return _createClass(e,[{key:"_render",value:function(){var e=template(),r=document.querySelector(".app-container");r.innerHTML=e;var n=new Search;r.querySelector(".app-component").appendChild(n.container)}}]),e}();module.exports=App;
},{"../../src/views/index.hbs":24,"./pages/search.js":23}],22:[function(require,module,exports){
...
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[7,">= 4.0.0"],main:function(e,a,n,l,s){var t;return'\t<div class="search">\r\n\t\t<input type="text" class="message" placeholder="Location..">\r\n\t</div>\r\n\r\n\t<div class="btn" class="btn" onclick="search();" '+e.escapeExpression((t=null!=(t=n.disabled||(null!=a?a.disabled:a))?t:n.helperMissing,"function"==typeof t?t.call(null!=a?a:e.nullContext||{},{name:"disabled",hash:{},data:s}):t))+">\r\n\t\t<span>Search</span>\r\n\t</div>\r\n"},useData:!0});
},{"hbsfy/runtime":20}]},{},[22])
