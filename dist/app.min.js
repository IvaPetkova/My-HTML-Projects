...
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[7,">= 4.0.0"],main:function(e,n,a,l,s){var t;return'\t<div class="search-component">\n\t\t<input type="text" class="message" placeholder="Type location..">\n\t</div>\n\n\t<div class="btn" class="btn" onclick="search();" '+e.escapeExpression((t=null!=(t=a.disabled||(null!=n?n.disabled:n))?t:a.helperMissing,"function"==typeof t?t.call(null!=n?n:e.nullContext||{},{name:"disabled",hash:{},data:s}):t))+">\n\t\t<span>Search</span>\n\t</div>\n"},useData:!0});
},{"hbsfy/runtime":20}]},{},[22])
